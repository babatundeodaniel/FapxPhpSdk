...
/**
 * This class stands for AccountCard StructType
 * @subpackage Structs
 */
class AccountCard extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Account;
    /**
     * Constructor method for AccountCard
     * @uses AccountCard::setID()
     * @uses AccountCard::setAccountID()
     * @uses AccountCard::setChannelID()
     * @uses AccountCard::setStatus()
     * @uses AccountCard::setDateCreated()
     * @uses AccountCard::setDateModified()
     * @uses AccountCard::setInitiatorID()
     * @uses AccountCard::setVerifierID()
     * @uses AccountCard::setVerifiedDate()
     * @uses AccountCard::setMoveNext()
     * @uses AccountCard::setNextApproverUserID()
     * @uses AccountCard::setNextApproverRoleID()
     * @uses AccountCard::setWorkFlowTransactionID()
     * @uses AccountCard::setCardPAN()
     * @uses AccountCard::setCallBackEmails()
     * @uses AccountCard::setExpiryYear()
     * @uses AccountCard::setExpiryMonth()
     * @uses AccountCard::setPIN()
     * @uses AccountCard::setDescription()
     * @uses AccountCard::setCreatedBy()
     * @uses AccountCard::setModifiedBy()
     * @uses AccountCard::setWorkFlowTransactionIDs()
     * @uses AccountCard::setAccount()
     * @param int $iD
     * @param int $accountID
     * @param int $channelID
     * @param int $status
     ...
     */
    public function __construct($iD = null, $accountID = null, $channelID = null, $status = null, $dateCreated = null, $dateModified = null, $initiatorID = null, $verifierID = null, $verifiedDate = null, $moveNext = null, $nextApproverUserID = null, $nextApproverRoleID = null, $workFlowTransactionID = null, $cardPAN = null, $callBackEmails = null, $expiryYear = null, $expiryMonth = null, $pIN = null, $description = null, $createdBy = null, $modifiedBy = null, $workFlowTransactionIDs = null, \StructType\Account $account = null)
    {
        $this
            ->setID($iD)
