...
/**
 * This class stands for SendPaymentList StructType
 * @subpackage Structs
 */
class SendPaymentList extends AbstractStructBase
{
    /**
     * The Transactions
    ...
    /**
     * Constructor method for SendPaymentList
     * @uses SendPaymentList::setTransactions()
     * @uses SendPaymentList::setBatchDescription()
     * @uses SendPaymentList::setCustomNarration()
     ...
     * @param \ArrayType\ArrayOfPaymentTrans $transactions
     * @return \StructType\SendPaymentList
     */
