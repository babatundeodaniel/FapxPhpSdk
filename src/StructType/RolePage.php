...
/**
 * This class stands for RolePage StructType
 * @subpackage Structs
 */
class RolePage extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Page;
    /**
     * Constructor method for RolePage
     * @uses RolePage::setID()
     * @uses RolePage::setRoleID()
     * @uses RolePage::setPageID()
     * @uses RolePage::setStatus()
     * @uses RolePage::setDateCreated()
     * @uses RolePage::setDateModified()
     * @uses RolePage::setInitiatorID()
     * @uses RolePage::setVerifierID()
     * @uses RolePage::setVerifiedDate()
     * @uses RolePage::setMoveNext()
     * @uses RolePage::setNextApproverUserID()
     * @uses RolePage::setNextApproverRoleID()
     * @uses RolePage::setWorkFlowTransactionID()
     * @uses RolePage::setCreatedBy()
     * @uses RolePage::setModifiedBy()
     * @uses RolePage::setWorkFlowTransactionIDs()
     * @uses RolePage::setPage()
     * @param int $iD
     * @param int $roleID
     * @param int $pageID
     * @param int $status
     ...
     */
    public function __construct($iD = null, $roleID = null, $pageID = null, $status = null, $dateCreated = null, $dateModified = null, $initiatorID = null, $verifierID = null, $verifiedDate = null, $moveNext = null, $nextApproverUserID = null, $nextApproverRoleID = null, $workFlowTransactionID = null, $createdBy = null, $modifiedBy = null, $workFlowTransactionIDs = null, \StructType\Page $page = null)
    {
        $this
            ->setID($iD)
            ->setRoleID($roleID)
