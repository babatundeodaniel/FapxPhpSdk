...
/**
 * This class stands for GetTransactionUpdateXml StructType
 * @subpackage Structs
 */
class GetTransactionUpdateXml extends AbstractStructBase
{
    /**
     * The UploadRefNo
    ...
    public $UploadRefNo;
    /**
     * Constructor method for GetTransactionUpdateXml
     * @uses GetTransactionUpdateXml::setUploadRefNo()
     ...
     * @param string $uploadRefNo
     * @return \StructType\GetTransactionUpdateXml
     */
